  ...
  return (
    ...
    >
      ...
      <label className="select-box--item ">
        ...
        <p className="font-[500] text-[14px]">Reply</p>
      </label>
      {/* item2 */}
      <label className="select-box--item ">
        {/* icon */}
        ...
        <p className="font-[500] text-[14px]">Edit</p>
      </label>
      {/* item2 */}
      <label className="select-box--item ">
        {/* icon */}
        <BsPin size={17} className="self-start mr-1.5" />
        <p className="font-[500] text-[14px]">Pin</p>
      </label>
      {/* item2 */}
      <label className="select-box--item ">
        {/* icon */}
        ...
        <p className="font-[500] text-[14px] ml-1">Forward</p>
      </label>
      {/* item2 */}
      <label className="select-box--item  ">
        {/* icon */}
        ...
        />
        <p className="font-[500] text-[14px]">Select</p>
      </label>
      {/* item2 */}
      <label className="select-box--item  text-red-500">
        {/* icon */}
        <svg
      width={18}
      height={18}
