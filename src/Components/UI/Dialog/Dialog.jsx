            ...
            >
                ...
                <div className=" flex flex-col gap-6 px-7 w-full">
                    ...
                    <div className="self-end flex items-center gap-x-1">
                        <button className="btn bg-transparent border-none text-[#8774e1] text-lg px-5 hover:bg-[rgba(135,116,225,0.08)]" onClick={()=>setShowAlert(false)}>
                            Cancel
                        </button>
