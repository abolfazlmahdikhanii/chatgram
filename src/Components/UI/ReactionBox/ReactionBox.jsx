...
const ReactionBox = ({ reaction, setReaction }) => {
  return (
    <div
      className=" bg-gray-300/30  px-2 py-1  rounded-lg flex items-center justify-between my-2.5 w-[65px] ml-auto backdrop-blur-md cursor-pointer border-2 border-indigo-700"
